...
Wang, Liguo, Shengqin Wang, and Wei Li. "RSeQC: quality control of RNA-seq experiments." Bioinformatics 28.16 (2012): 2184-2185.
and FastQC https://github.com/s-andrews/FastQC
"""
...
rule fastqc:
    ...
    output: html="qc/fastqc/{sample}_fastqc.html",
...
rule rseqc_junction_annotation:
    input: bed="ref.bed12",
         bam="mappings/{sample}.bam"
    output: "qc/rseqc/{sample}.splice_junction.pdf",
...
rule read_distribution:
    input: bam="mappings/{sample}.bam",
         bed="ref.bed12"
    output: "qc/rseqc/{sample}.read_distribution.txt"
